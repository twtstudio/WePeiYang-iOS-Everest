...
class WeekItemCell: UIView {
    ...
    func load(courses: [[Bool]], week: Int) {
        ...
        attrString.addAttributes([NSAttributedString.Key.font: UIFont.systemFont(ofSize: 9)], range: NSRange(location: 0, length: 1))
        let length = week > 9 ? 2 : 1
        attrString.addAttributes([NSAttributedString.Key.font: UIFont.systemFont(ofSize: 18)], range: NSRange(location: 1, length: length))
        attrString.addAttributes([NSAttributedString.Key.font: UIFont.systemFont(ofSize: 9)], range: NSRange(location: 1 + length, length: 1))
        attrString.addAttributes([NSAttributedString.Key.foregroundColor: UIColor(red: 0.27, green: 0.39, blue: 0.49, alpha: 1.00)], range: NSRange(location: 0, length: 2 + length))
