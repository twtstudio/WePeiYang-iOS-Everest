...
//        UIApplication.shared.setStatusBarStyle(.lightContent, animated: true)
    ...
    func initUI() {
        ...
        leftArrowView1.snp.makeConstraints { make in
            make.centerY.equalTo(scrollView1.snp.centerY)
            //make.right.equalTo(mainScrollView)
            make.left.equalTo(view).offset(8)
        }

        rightArrowView1.snp.makeConstraints { make in
            make.centerY.equalTo(scrollView1.snp.centerY)
            make.right.equalTo(view).offset(-8)
        }

        leftArrowView2.snp.makeConstraints { make in
            make.centerY.equalTo(scrollView2.snp.centerY)
            //make.right.equalTo(mainScrollView)
            make.left.equalTo(view).offset(8)
        }

        rightArrowView2.snp.makeConstraints { make in
            make.centerY.equalTo(scrollView2.snp.centerY)
            make.right.equalTo(view).offset(-8)
        }
