...
struct Courses {
    ...
    static func getCourseList(and completion: @escaping () -> ()) {
...
//            }
//            //courselist 打错
//            guard (dict["status"])! as? Int == 1, let fooCourses = dict["courselist"] as? Array<NSDictionary> else {
//                MsgDisplay.showErrorMsg("服务器开小差啦！")
//                return
//            }
//            
...
//        })
    ...
    struct Study20 {
        ...
        static func getCourseDetail(of courseID: String, and completion: @escaping () -> ()) {
...
//                }
//                    
//                guard dict["status"] as? Int == 1, let fooDetails = dict["data"] as? Array<NSDictionary> else {
//                    MsgDisplay.showErrorMsg("服务器开小差啦！")
//                    return
//                }
//                    
...
//                
//                //TODO: 目前不知道 filecontent 就是 String 还是 Array<NSDictionary>
//                guard dict["status"] as? Int == 1, let fooArticle = dict["data"] as? NSDictionary else {
//                    MsgDisplay.showErrorMsg("服务器开小差啦！")
//                    return
//                }
//                
...
//            }
    ...
    //获得理论经典列表
    static func getTextList(and completion: @escaping () -> ()) {
...
//                return
//            }
//            guard dict["status"] as? Int == 1, let fooTexts = dict["textlist"] as? Array<NSDictionary> else {
//                MsgDisplay.showErrorMsg("服务器开小差啦！")
//                return
//            }
//            
