...
public protocol AlertOnboardingDelegate: class {
...
open class AlertOnboarding: UIView, AlertPageViewDelegate {
    ...
    open weak var delegate: AlertOnboardingDelegate?
    ...
    open func show() {
        ...
        self.buttonBottom.setTitleColor(colorButtonText, for: [.normal, .highlighted, .disabled, .selected, .focused, .application, .reserved])
        self.buttonBottom.setTitle(self.titleSkipButton, for: [.normal, .highlighted, .disabled, .selected, .focused, .application, .reserved])
    ...
    fileprivate func interceptOrientationChange() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(AlertOnboarding.onOrientationChange), name: Notification.Name.UIDeviceOrientationDidChange, object: nil)
    }
