//
//  ThirdProgressRateController.swift
//  WePeiYang
//
...
class ThirdProgressRateController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        imageView = UIImageView(image: ImageData.repairFullImage)
        oneLabel = UILabel()
        twoLabel = UILabel()
        threeLabel = UILabel()
        fourLabel = UILabel()
...
extension ThirdProgressRateController: UITableViewDelegate, UITableViewDataSource {
