//
//  SixthProgressControlleer.swift
//  WePeiYang
//
//  Created by 赵家琛 on 2017/10/23.
//  Copyright © 2017年 twtstudio. All rights reserved.
//

import UIKit

class SixthProgressRateController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        imageView = UIImageView(image: ImageData.finishImage)
        oneLabel = UILabel()
        twoLabel = UILabel()
        threeLabel = UILabel()
        fourLabel = UILabel()
        ...
        fourLabel.text = "已完成"
        fourLabel.textColor = UIColor(red: 0.55, green: 0.78, blue: 0.59, alpha: 1.00)
        //labelFour.alpha = 0.5
...
extension SixthProgressRateController: UITableViewDelegate, UITableViewDataSource {
