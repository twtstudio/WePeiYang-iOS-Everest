...
struct ReadBeacon {
    static func request(_ url: String, method: HTTPMethod = HTTPMethod.get, parameters: [String: Any]? = nil, headers: [String: String]? = nil, failureMessage: String?, failure: ((Dictionary<String, AnyObject>)->(Void))? = nil, success: @escaping (Dictionary<String, AnyObject>)->(Void)) {
