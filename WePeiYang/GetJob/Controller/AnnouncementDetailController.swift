...
class AnnouncementDetailController: UIViewController {
    ...
    var announcementDetail: AnnouncementDetail!
...
//        let RecruitmentUrl = "http://job.api.twtstudio.com/api/notice/detail?type=0&id=\(didSelectCell.id)"
        print(didSelectCell.id)
        AnnouncementDetailHelper.getAnnouncementDetail(success: { announcementDetail in
            
            self.announcementDetail = announcementDetail
            
            self.titleLable.text = self.announcementDetail.data?.title!
            self.visitsLable.text = "\(String(describing: self.announcementDetail.data!.click!))"
            self.timeLable.text = self.announcementDetail.data?.date!
            
            let content = self.announcementDetail.data?.content!
            ...
            if self.announcementDetail.data?.attach1 != nil {
                self.attachArray.append((self.announcementDetail.data?.attach1!)!)
                ...
                self.fileBtn1.setTitle(self.announcementDetail.data?.attach1Name!, for: .normal)
            ...
            if self.announcementDetail.data?.attach2 != nil {
                self.attachArray.append((self.announcementDetail.data?.attach2!)!)
                ...
                self.fileBtn2.setTitle(self.announcementDetail.data?.attach2Name!, for: .normal)
            ...
            if self.announcementDetail.data?.attach3 != nil {
                self.attachArray.append((self.announcementDetail.data?.attach3!)!)
                ...
                self.fileBtn3.setTitle(self.announcementDetail.data?.attach3Name!, for: .normal)
