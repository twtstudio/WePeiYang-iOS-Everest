...
class BicycleServiceViewController: WMPageController {
    ...
    convenience init() {
        self.init(viewControllerClasses: [BicycleServiceMapController.self, BicycleServiceInfoController.self, BicycleServiceNotificationController.self], andTheirTitles: ["", "", ""])
        self.title = "自行车"
