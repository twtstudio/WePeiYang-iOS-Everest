...
class BicycleNotificationDetailViewController: UIViewController{
    ...
    /*
     //iOS 8 fucking bug
     init(){
     super.init(nibName: "BicycleNotificationDetailViewController", bundle: nil)
     print("haha")
     }
    ...
    override func viewDidLoad() {
        ...
        //加载HTMLString
        self.contentWebView.loadHTMLString(self.renderHTMLWithTitle(title: notificationTitle!, content: notificationContent!, time: time!), baseURL: NSURL.fileURL(withPath: Bundle.main.resourcePath!))
    }
