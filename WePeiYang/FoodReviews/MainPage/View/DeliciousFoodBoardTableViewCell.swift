...
class DeliciousFoodBoardTableViewCell: UITableViewCell {
...
extension DeliciousFoodBoardTableViewCell {
    ...
    func setupPageControl() {
        ...
        pageControl = UIPageControl(frame: CGRect(x: 0, y: 150, width: self.frame.width, height: 10))
...
extension DeliciousFoodBoardTableViewCell:UICollectionViewDelegate, UICollectionViewDataSource {
