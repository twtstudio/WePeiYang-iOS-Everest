...
class LibraryPageContentView: UIView {
    ...
    weak var delegate: LibraryPageContentViewDelegate?
...
extension LibraryPageContentView {
...
extension LibraryPageContentView: UICollectionViewDataSource {
...
extension LibraryPageContentView: UICollectionViewDelegate {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        //将数据传递给titleView
        delegate?.libraryPageContentView(contentView: self, progress: progress, sourceIndex: sourceIndex, targetIndex: targetIndex)
    }
}
