...
class FBQuestionTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        msgImgView.snp.makeConstraints { (make) in
            ...
            make.top.lessThanOrEqualTo(contentLabel.snp.bottom).offset(60)
            make.bottom.equalTo(bgView.snp.bottom).offset(-7)
        }
        ...
        imgView.snp.makeConstraints { (make) in
            ...
            make.bottom.lessThanOrEqualTo(usernameLabel.snp.top).offset(-5)
